...
class ModelSyncInferenceExecutorTest {
    ...
    void setUp() throws Exception {
        ...
        predictProcessor = new ModelSyncInferenceExecutor(config, awsCredentialsSupplier);
    ...
    @Test
    void execute_multipleInputMappings_invokesModelForEachMapping() {
        ...
        predictProcessor = new ModelSyncInferenceExecutor(config, awsCredentialsSupplier);
        injectConnectorExecutorSilently(predictProcessor, connectorExecutor);
    ...
    @Test
    void execute_missingInputField_addsTagsAndReturnsRecord() {
    ...
    @Test
    void execute_modelReturnsNestedOutputPath_extractsCorrectly() {
    ...
    @Test
    void execute_remoteServiceThrows_addsTagsAndReturnsRecord() {
    ...
    @Test
    void execute_outputPathNotFound_addsTagAndReturnsRecord() {
        when(event.get("passage_text", String.class)).thenReturn("hello");
        when(event.getMetadata()).thenReturn(null);
        when(connectorExecutor.executeActionAndGetResponse(any(), any()))
    ...
    @Test
    void execute_noOutputMap_doesNotWriteToEvent() {
    ...
    private void injectConnectorExecutorSilently(final ModelSyncInferenceExecutor processor,
                                                  final RemoteConnectorExecutor executor) {
        injectConnectorExecutor(processor, executor);
    }
}
